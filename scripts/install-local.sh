#!/usr/bin/env bash
#
# install-local.sh — build Meridian and the opencode-claude plugin from source.
#
# Pipeline:
...
#
# Usage:
#   ./scripts/install-local.sh            build everything
#   ./scripts/install-local.sh --test     also run meridian's test suite
#
set -euo pipefail
